...
/// the role's stored name, exactly like the REST transcript in ch.10 of the manual. Drives through
/// the real host pipeline (ApiFactory), not <see cref="GraphQlMutationExecutionTests"/>'s fake data
