...
describe('locale packs', () => {
  ...
  // Pins the maintainer's 2026-08-12 ruling against the real shipped pack, not a suite-local narrative-guard:allow: cites the specific ruling this test pins against, not a changelog date
