export default {
  ...
  errors: {
    ...
    tooManyRequestsWithWait: '嘗試次數過多,請於 {seconds} 秒後再試。',
  },
  password: {
    changeTitle: '變更密碼',
    changeDescription: '輸入目前的密碼,然後設定新密碼。',
    resetTitle: '重設密碼',
    resetDescription: '為這位使用者設定新密碼,之後他可以自行變更。',
    current: '目前密碼',
    ...
    changed: '密碼已更新。',
    mismatch: '兩次輸入的密碼不一致。',
    tooShort: '密碼至少需要 {min} 個字元。',
    generate: '產生強密碼',
    generatedAndCopied: '已產生密碼並複製到剪貼簿。',
    copyFailed: '無法複製到剪貼簿,請手動複製。',
    invalidCurrent: '目前密碼不正確。',
    noLocalPassword: '此帳號使用外部登入提供者,沒有本機密碼。',
    forbidden: '您沒有變更這組密碼的權限。',
    notFound: '該使用者已不存在。',
    failed: '無法更新密碼。',
  },
  breadcrumb: {
  ...
  media: {
    ...
    colTypeFolder: '資料夾',
    detailTitle: '檔案詳情',
    detailDescription: '檢視此檔案的預覽與中繼資料,並編輯標題或替代文字。',
    fieldTitle: '標題',
    fieldAlt: '替代文字 (alt)',
    fileUrl: '檔案 URL',
    copyUrl: '複製 URL',
    ...
    uploadTitle: '上傳檔案',
    uploadDescription: '將檔案拖放到這裡,或點擊瀏覽,然後上傳到此資料夾。',
    loadFailed: '載入媒體失敗',
    deleteFailed: '刪除失敗',
    saveFailed: '儲存失敗',
    folderNew: '新增資料夾',
    folderName: '資料夾名稱',
    folderNameDescription: '輸入這個資料夾的名稱。',
    folderConfirm: '確定',
    ...
    moved: '已移動 {n} 個項目',
    moveTo: '移動至…',
    moveDescription: '選擇要將所選項目移動到的目的資料夾。',
    moveRoot: '根目錄',
    moveSubmit: '移動',
    menuOpen: '開啟',
    menuMove: '移動至…',
  ...
  fields: {
    ...
    clear: '清除',
    selectAFile: '選擇檔案',
    selectAFileDescription: '瀏覽或搜尋已上傳的檔案,選擇一個作為此欄位的值。',
    searchFiles: '搜尋檔名…',
    loadFilesFailed: '載入檔案失敗',
    noFilesSelected: '尚未選擇檔案',
    selectFiles: '選擇檔案',
    selectFilesDescription: '瀏覽或搜尋已上傳的檔案,勾選以加入或移出此欄位的清單。',
    done: '完成',
    ...
    richtext: {
      ...
      insertImageDescription: '瀏覽或搜尋媒體庫,選擇一張圖片插入到文字中。',
      ...
      editAlt: '編輯替代文字', deleteImage: '刪除圖片',
      altDialogTitle: '替代文字',
      altDialogDescription: '為螢幕閱讀器描述這張圖片,或留空以標示為裝飾性圖片。',
      altLabel: '替代文字',
      table: '表格',
      ...
      tableSizeCols: '{count} 欄', tableSizeRows: '{count} 列',
      customSize: '自訂尺寸…',
      customSizeTitle: '插入表格',
      customSizeDescription: '設定即將插入表格的列數與欄數。',
      rows: '列數', columns: '欄數',
      withHeaderRow: '包含表頭列',
