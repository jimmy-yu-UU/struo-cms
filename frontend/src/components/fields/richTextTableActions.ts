...
// The set of actions the context menu (RichTextContextMenu) places a separator before the
...
// once. RichTextContextMenu.test.ts pins the "exactly one separator" outcome.
