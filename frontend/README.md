...
for the full quick-start (starting the API alongside this SPA) and [chapter 19](../docs/guide/en/19-admin-customization.md)
...
tracked diff at all before moving on (not just to `Struo.Api.csproj`) — chapter 23's
