...
The admin single-page app: Vue 3 + PrimeVue + TipTap, authenticating against the StruoCMS API
(`Struo.Api`). Built with Vite, Pinia and Vue Router. See [chapter 2](../docs/guide/en/02-getting-started.md)
