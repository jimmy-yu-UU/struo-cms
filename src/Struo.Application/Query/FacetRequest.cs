...
/// (Sonar S107: a method must not take more than 7 parameters). Carries exactly the same values the
/// unbundled overload used to take positionally — see the members' original doc comments on
